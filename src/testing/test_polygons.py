...
def polygon_contains():
    ...
    print('Test points on outline for outline:\n'
          ...
          '...and is:', [polygon.hits_point(point) for point in points_on_outline])
    print('Test points on outline for inside:\n'
          'should be:', [False] * len(points_on_outline), '\n'
          '...and is:', [polygon.surrounds_point(point) for point in points_on_outline], '\n')
    ...
    print('Test points inside for outline:\n'
          ...
          '...and is:', [polygon.hits_point(point) for point in points_inside])
    print('Test points inside for inside:\n'
          'should be:', [True] * len(points_inside), '\n'
          '...and is:', [polygon.surrounds_point(point) for point in points_inside], '\n')
    ...
    print('Test points outside for outline:\n'
          ...
          '...and is:', [polygon.hits_point(point) for point in points_outside])
    print('Test points outside for inside:\n'
          'should be:', [False] * len(points_outside), '\n'
          '...and is:', [polygon.surrounds_point(point) for point in points_outside], '\n')
